# Collecting data using the opencv and storing under the image folder
import os
import cv2
...
while True:
    _,frame=cap.read()
    #Counting all the images in the directory 
    count = {
    ...
    row = frame.shape[1]
    col = frame.shape[0]
    #Frame through which data is collected
    cv2.rectangle(frame,(0,40),(300,400),(255,255,255),2)
    cv2.imshow("data",frame)
    cv2.imshow("ROI",frame[40:400,0:300])
    frame=frame[40:400,0:300]
    interrupt = cv2.waitKey(10)
    #Image get stored at the folder keyboard is pressed
